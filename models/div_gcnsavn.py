...
class DIV_GCNSAVN(torch.nn.Module):
    ...
    def __init__(
        ...
        hidden_state_sz = 512
        super(DIV_GCNSAVN, self).__init__()
    ...
    def forward(self, model_input, params = None):
        ...
        x, image_embedding = self.embedding(state, res_score, target, action_probs, params)
    ...
    def learned_loss(self, learned_input, params=None):
        return learned_input
